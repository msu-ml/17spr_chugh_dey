...
if __name__ == "__main__":
  ...
  flags.DEFINE_float("learning_rate_decay_examples", 15000,
  ...
  with tf.device(tf.train.replica_device_setter(
    ...
    with tf.name_scope("model"):
      result = model.create_model(model_input,
                                  ...
                                  labels=labels_batch, batch_size=batch_size)
...
#  summary_writer1 = tf.summary.FileWriter(train_dir, sess.graph)
...
#      summary_writer1.add_summary(summary, global_step_val)
